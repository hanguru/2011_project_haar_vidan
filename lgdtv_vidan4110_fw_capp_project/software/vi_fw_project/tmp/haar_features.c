...
features_init(float win_ratio)
{
	...
	SET_MEMORY(f1, Haar_Feature, FEATURE_START_MEMORY_OFFSET);
	SET_MEMORY(f1->r1, Haar_FeatureRect, FEATURE_START_MEMORY_OFFSET + sizeof(Haar_Feature));
	SET_MEMORY(f1->r2, Haar_FeatureRect, FEATURE_START_MEMORY_OFFSET + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect));
	SET_MEMORY(f1->r3, Haar_FeatureRect, FEATURE_START_MEMORY_OFFSET + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect) * 2);

	offset += sizeof(Haar_Feature) + sizeof(Haar_FeatureRect)*3;

	SET_MEMORY(f2, Haar_Feature, offset);
	SET_MEMORY(f2->r1, Haar_FeatureRect, offset + sizeof(Haar_Feature));
	SET_MEMORY(f2->r2, Haar_FeatureRect, offset + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect));
	SET_MEMORY(f2->r3, Haar_FeatureRect, offset + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect) * 2);

	offset += sizeof(Haar_Feature) + sizeof(Haar_FeatureRect)*3;

	SET_MEMORY(f3, Haar_Feature, offset);
	SET_MEMORY(f3->r1, Haar_FeatureRect, offset + sizeof(Haar_Feature));
	SET_MEMORY(f3->r2, Haar_FeatureRect, offset + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect));
	SET_MEMORY(f3->r3, Haar_FeatureRect, offset + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect) * 2);
	...
	SET_MEMORY(n, int, FEATURE_COUNT_OFFSET);
	*n = 3;
...
features_get_total()
{
	...
	SET_MEMORY(t, int, FEATURE_COUNT_OFFSET);
...
{	
	...
	if (!Haar_init) {
        //MSG(F_ONE);
		SET_MEMORY(f, Haar_Feature, FEATURE_WORKING_MEMORY_OFFSET);
        //MSG(F_TWO);
	
		SET_MEMORY(f->r1, Haar_FeatureRect, FEATURE_WORKING_MEMORY_OFFSET + sizeof(Haar_Feature));
		SET_MEMORY(f->r2, Haar_FeatureRect, FEATURE_WORKING_MEMORY_OFFSET + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect));
		SET_MEMORY(f->r3, Haar_FeatureRect, FEATURE_WORKING_MEMORY_OFFSET + sizeof(Haar_Feature) + sizeof(Haar_FeatureRect) * 2);
