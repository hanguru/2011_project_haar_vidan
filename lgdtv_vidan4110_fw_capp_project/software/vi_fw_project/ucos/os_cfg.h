...
#define OS_LOWEST_PRIO           6    /* Defines the lowest priority that can be assigned ...         */
...
/* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_STAT_STK_SIZE  0x1000  /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE  0x0040  /* Idle task stack size (# of OS_STK wide entries)              */
