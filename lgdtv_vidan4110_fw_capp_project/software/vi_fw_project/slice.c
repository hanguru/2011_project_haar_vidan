...
/*
   if( img.type==P_SLICE &&
      ...
      img.number%fake_intra_period!=(fake_intra_period-1)) {
       img.prev_qp=img.qp;
       simpleLineRateControl (first_mb_in_slice/(img.width>>4), img.height>>4);
       ME_CR2 = img.qp;
...
// int temp_mb_x = 0;
  ...
  // hjlee 2010.07.01 begin
  int cond_ptype = 0; 
  int img_number_div_fake_intra_period = 0; 
  
     img_number_div_fake_intra_period = img.number/fake_intra_period; 
  cond_ptype = (img.type==P_SLICE) 
		&& (img.number%fake_intra_period==(fake_intra_period-1))
		? 1: 0;
  // hjlee 2010.07.01 end 
...
//select resolution of image  
 ...
 //random number generation for now frame intra mode lines => 1line
      if(img.type==P_SLICE && img.number/fake_intra_period==0 && img.number!=1 )
      {
       if(H264_RESOLUTION == H264_VGA)
       {
          if((img_number_div_fake_intra_period)%mb_sub_groups == 0){
            random_temp0 = 0; random_temp1 = 6; random_temp2 = 12; random_temp3 = 18; random_temp4 = 24;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 2){
            random_temp0 = 1; random_temp1 = 7; random_temp2 = 13; random_temp3 = 19; random_temp4 = 25;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 4){
            random_temp0 = 2; random_temp1 = 8; random_temp2 = 14; random_temp3 = 20; random_temp4 = 26;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 5){
            random_temp0 = 3; random_temp1 = 9; random_temp2 = 15; random_temp3 = 21; random_temp4 = 27;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 3){
            random_temp0 = 4; random_temp1 = 10; random_temp2 = 16; random_temp3 = 22; random_temp4 = 28;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 1){
            random_temp0 = 5; random_temp1 = 11; random_temp2 = 17; random_temp3 = 23; random_temp4 = 29;
          }
       }
       else if( H264_RESOLUTION == H264_QVGA)
       {
          if((img_number_div_fake_intra_period)%mb_sub_groups == 1){
            random_temp0 = 0; random_temp1 = 3; random_temp2 = 6; random_temp3 = 9; random_temp4 = 12;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 0){
            random_temp0 = 1; random_temp1 = 4; random_temp2 = 7; random_temp3 = 10; random_temp4 = 13;
          }
          else if((img_number_div_fake_intra_period)%mb_sub_groups == 2){
            random_temp0 = 2; random_temp1 = 5; random_temp2 = 8; random_temp3 = 11; random_temp4 = 14;
          }
...
//     }
  ...
  // hjlee 2010.07.01 begin
     ...
     if(cond_ptype &&
        (mby/intra_mb_lines==((img.number/fake_intra_period-1)%mb_sub_groups)) 
	&& img.number!=1) intra_line_prev = 1;//intra
     else                                                                                          intra_line_prev = 0; //skip
  // hjlee 2010.07.01 end 

    // hjlee 2010.07.01 comment out begin  
//    if(img.type==P_SLICE &&
//        img.number%fake_intra_period==(fake_intra_period-1) &&
//        ((mby/intra_mb_lines)==(((img.number/fake_intra_period)-1)%mb_sub_groups)) && img.number!=1)intra_line_prev = 1;//intra
//     else                                                                                          intra_line_prev = 0; //skip
    // hjlee 2010.07.01 comment out end 
...
////////////////////////////////////////////////////////////////
     ...
     if(mby == random_temp0 || mby == random_temp1 || mby == random_temp2 || mby == random_temp3 || mby == random_temp4)
       select_num = 1;
     else
       select_num = 0;
     ...
     if(img.type==P_SLICE && img.number%fake_intra_period==0 && img.number!=1 && select_num == 1) //intra mode
      ...
      cond1 =
            (!(img.type==P_SLICE && img.number%fake_intra_period==0 
		&& intra_line_curr==0)) 
		? 1 : 0;
			  ...
			  if(img_type) {
				   ...
				   DCTQ_CR2 = mby;
			          ...
			          //OS_ENTER_CRITICAL();         // memaccess_me begin
                                  ...
                                  if(cond1)VLC_CR0 = (0x1|((img.number&0x7f)<<1));//2010.06.04
