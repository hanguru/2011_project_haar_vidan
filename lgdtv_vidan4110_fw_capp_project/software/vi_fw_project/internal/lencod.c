...
#define MIN_SIMPLE_RATE_CONTROL_QP		8 // hjlee 2010.06.25	
...
int diff_one_frame_size_byte=0;
int diff_two_frame_size_byte=0;
int diff_four_frame_size_byte=0;
int diff_one_frame_size_byte_prev1=0;
int diff_one_frame_size_byte_prev2=0;
int diff_one_frame_size_byte_prev3=0;
int diff_one_frame_size_byte_prev4=0;
...
void simpleRateControl(void)
{
	...
	diff_one_frame_size_byte = result_one_frame_size_byte - target_one_frame_size_byte;
	diff_two_frame_size_byte = (diff_one_frame_size_byte_prev1
				  + diff_one_frame_size_byte_prev2)>>1;
	diff_four_frame_size_byte = (diff_one_frame_size_byte_prev1
				  + diff_one_frame_size_byte_prev2
				  + diff_one_frame_size_byte_prev3
				  + diff_one_frame_size_byte_prev4)>>2;

	if  ( diff_one_frame_size_byte < -2048)
	{
//		if(diff_four_frame_size_byte < -12298) 	
//			input.qpN -= 10;
//		if(diff_four_frame_size_byte < -10250) 	
//			input.qpN -= 9;
//		if(diff_four_frame_size_byte < -8192) 	
//			input.qpN -= 8;
//		if(diff_four_frame_size_byte < -6144 ) 	
//			input.qpN -= 7;
		if(diff_four_frame_size_byte < -4096 ) 	
			input.qpN -= 6;
		else if(diff_four_frame_size_byte < - 2048) 	
			input.qpN -= 5;
		else if(diff_four_frame_size_byte < - 1024) 	
			input.qpN -= 4;
		else
			input.qpN -=3;
	}
	else if ( diff_one_frame_size_byte > 2048 )
	{
//		if(diff_four_frame_size_byte > 12298 ) 	
//			input.qpN += 11;
//		if(diff_four_frame_size_byte > 10250 ) 	
...
//	else if ( diff_one_frame_size_byte < -1536)
//	{	
////		if(diff_four_frame_size_byte < -8192) 	
////			input.qpN -= 7;
//		if(diff_four_frame_size_byte < -6144 ) 	
//			input.qpN -= 6;
//		else if(diff_four_frame_size_byte < -4096 ) 	
//			input.qpN -= 5;
//		else if(diff_four_frame_size_byte < - 2048) 	
//			input.qpN -= 4;
//		else if(diff_four_frame_size_byte < -1536) 	
//			input.qpN -= 3;
//		else
//			input.qpN -= 2;
//		more_than_orig_target_cnt=0; // hjlee 2010.06.25
//	}
//	else if ( diff_one_frame_size_byte > 1536)
//	{	
////		if(diff_four_frame_size_byte > 10250 ) 	
...
//	}
	else if  ( diff_one_frame_size_byte < -1024 )
	{
//		if(diff_four_frame_size_byte < -8192) 	
//			input.qpN -= 7;
		if(diff_four_frame_size_byte < -4096) 	
			...
			input.qpN -= 4;
		else if(diff_four_frame_size_byte < -512) 	
			input.qpN -=3;
		else if(diff_four_frame_size_byte < 0) 	
			input.qpN -=2;
		else if(diff_four_frame_size_byte > 512) 	
			input.qpN -=0;
		else 
...
//	else if  ( diff_one_frame_size_byte < -768 )
//	{
//		input.qpN -= 2;
//		if (qpN_minus_1_flag) {
//			input.qpN -= 1;
...
//		less_than_orig_target_cnt=0; // hjlee 2010.06.25
//	}
	else if  ( diff_one_frame_size_byte < -512 )
	{
		if(diff_four_frame_size_byte < -4096) 	
			input.qpN -= 4;
		else if(diff_four_frame_size_byte < -2048) 	
		    ...
		    if(diff_four_frame_size_byte > 768) 	
			input.qpN -=2;
		    else 
			input.qpN -=3;
		else if(diff_four_frame_size_byte < -378) 	
		    if(diff_four_frame_size_byte > 378) 	
			input.qpN -=1;
		    else input.qpN -=2;
		else if(diff_four_frame_size_byte > 378) 	
			input.qpN -=0;
		else 
//		    if(diff_one_frame_size_byte_prev1 > 1024) 	
//			input.qpN -=0;
//		    else 
			input.qpN -=1;
	}
...
//	else if (diff_one_frame_size_byte < -384) {
//		input.qpN -= 1;
//		if (qpN_minus_1_flag) {
//			input.qpN -= 1;
//			qpN_minus_1_flag = 0;
...
//		less_than_orig_target_cnt=0; // hjlee 2010.06.25
//	}
	else if  ( diff_one_frame_size_byte < -378)
	{
		if(diff_four_frame_size_byte < -2048) 	
			input.qpN -= 4;
		else if(diff_four_frame_size_byte < -1024) 	
			input.qpN -= 3;
		else if(diff_four_frame_size_byte < -512) 
	...
	{	
	    ...
	    if  ( diff_one_frame_size_byte < -256) {
		if( (diff_four_frame_size_byte < -378) 
		    || (diff_two_frame_size_byte < -256) 	
		    || (diff_one_frame_size_byte_prev1 < -256) ) 	
			input.qpN -=1;
		else
			input.qpN -= 0;
	    }
	    else if  ( diff_one_frame_size_byte > 256)
	    {
		if( (diff_four_frame_size_byte > 378) 	
		   || (diff_two_frame_size_byte > 256) 	
		   || (diff_one_frame_size_byte_prev1 > 256)) 	
...
*/
	...
	diff_one_frame_size_byte_prev4=diff_one_frame_size_byte_prev3;
	diff_one_frame_size_byte_prev3=diff_one_frame_size_byte_prev2;
	diff_one_frame_size_byte_prev2=diff_one_frame_size_byte_prev1;
	diff_one_frame_size_byte_prev1=diff_one_frame_size_byte;
